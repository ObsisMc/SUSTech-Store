      ...
      <el-form :model="loginForm" :rules="loginRules" ref="loginForm" label-width="0px">
        ...
        <el-form-item label="" prop="userName" style="margin-top:40px;">
          <el-row>
            ...
            <el-col :span='22'>
              <el-input class="inps" placeholder='用户名' v-model="loginForm.userName">
              </el-input>
            </el-col>
          </el-row>
        </el-form-item>
        ...
        <el-form-item label="" prop="passWord">
          <el-row>
            ...
            <el-col :span='22'>
              <el-input type="password" class="inps" placeholder='密码' v-model="loginForm.passWord"
              ></el-input>
            </el-col>
          </el-row>
        </el-form-item>
...
#login {
  ...
  color: #fff;
  //background-size: 100%;
  background-image: url("../../assets/sustech.jpg");
  position: relative;
